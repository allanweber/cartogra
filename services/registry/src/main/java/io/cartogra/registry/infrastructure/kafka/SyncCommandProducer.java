...
public class SyncCommandProducer {
    ...
    public SyncCommandProducer(KafkaTemplate<String, Object> kafkaTemplate, ObjectMapper objectMapper) {
    ...
    public void publish(ScmConnection connection) {
        ...
        var record = new ProducerRecord<String, Object>(TOPIC, connection.id().toString(), envelope);
